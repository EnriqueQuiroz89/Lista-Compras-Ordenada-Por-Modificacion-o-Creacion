...
function checkInputs() {
    ...
    const articuloValue = miArticulo.value.trim(),
        cantidadValue = miCantidad.value.trim(),
        notaValue = miNota.value.trim();
...
let comprasRef = db.collection("compras");
...
function editar(id, articulo, cantidad, nota, imagen) {
    ...
    btnGuardarEdicion.onclick = function () {
        ...
        let compraRef = db.collection("compras").doc(id);
        // Capturar los cambios realizados en los campos
        let articuloEditado = document.getElementById('articulo').value,
            cantidadEditada = document.getElementById('cantidad').value,
            notaEditada = document.getElementById('nota').value,
